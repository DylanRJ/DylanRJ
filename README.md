...
I submitted my review which recommended changing some of the relationships in the  architecture in order to better represent those real-world relationships for the users of the environment who were becoming dismayed at using the system. Followed by a data migration and cleansing exercise to refit the data into the new structure.
